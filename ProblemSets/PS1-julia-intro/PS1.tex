...
\begin{enumerate}
\item Import the file \texttt{nlsw88.csv} into Julia as a \texttt{DataFrame}. Make sure you appropriately convert missing values and variable names. Save the result as \texttt{nlsw88.jld}.
...
\item Turn in your files as a commit to the \texttt{ProblemSets/PS1-julia-intro/} folder on your GitHub fork. You can do this by simply clicking ``upload files'' in the appropriate folder, or you can use the GitHub desktop app, RStudio, VS Code, or the command line to stage, commit and push the files.
\end{enumerate}
